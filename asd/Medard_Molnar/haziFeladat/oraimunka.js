...
// }
// console.log(lottoWrite("skandi", "joker"))

let array=[1,2,3,54,65,7,89,9,4,44,88]

function valogatas(array1){
    let parosak=[]
    for(let i=0;i<array1.length;i++){
        if (array1[i]%2===0)parosak.push(array1[i])
    }
    return parosak
}

console.log(valogatas(array))
